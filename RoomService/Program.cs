...
// Add custom JSON config
builder.Configuration.AddJsonFile("Room.appsettings.json", optional: false, reloadOnChange: true);
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "RoomService V1");
    });
}
app.UseSwagger();
app.UseSwaggerUI(c =>
